...
const equations_list = preload("res://MiniGames/MathVaults/Scripts/equations_list.gd")
...
func _ready():
	...
	if equation.image:
		screen_container.get_node("Img").texture = load("res://MiniGames/MathVaults/Assets/EquationsImg/" + equation.image)
